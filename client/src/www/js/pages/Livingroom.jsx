...
@connect((store) => {
    ...
    return {
        data:store.Status.data.Livingroom,
    };
})
...
export default class Livingroom extends React.Component {
    ...
    handleToggle(name,state) {
        ...
        this.props.dispatch(sendCommand("Set","Light",{Livingroom:name}));
        //let obj = "L"+name;
    ...
    render() {
        ...
        return (
            <div className="container-fluid">
                <h3 style={{paddingRight:"15px"}}> Svetainė </h3>
                ...
                <div className="col-xs-12 col-lg-9">
                    ...
                    <table  className="table" style={{paddingLeft:"30px"}}>
                        <tbody>
                            ...
                            <tr>
                                <td style={td_style} className="my-label">Virtuvė LED: </td>
                                <td style={td_style} >
                                    <ToggleButton
                            ...
                            <tr>
                                <td style={td_style} className="my-label">Virtuvė: </td>
                                <td style={td_style} >
                                    <ToggleButton
                            ...
                            <tr>
                                <td style={td_style} className="my-label">Virtuvė stalas: </td>
                                <td style={td_style} >
                                    <ToggleButton
                                        value={ this.props.data.L4 == "1" }
                                        onToggle={this.handleToggle.bind(this,4)} />
                                </td>
                            </tr>

                            <tr>
                                <td style={td_style} className="my-label">Salionas: </td>
                                <td style={td_style} >
                                    <ToggleButton
                            ...
                            <tr>
                                <td style={td_style} className="my-label">Salionas LED: </td>
                                <td style={td_style} >
                                    <ToggleButton
                                        value={ this.props.data.L5 == "1" }
                                        onToggle={this.handleToggle.bind(this,5)} />
                                </td>
                            </tr>

                            <tr>
                                <td style={td_style} className="my-label">Ventiliacija: </td>
                                <td style={td_style} >
                                    <ToggleButton
                                        value={ this.props.data.L3 == "1" }
                                        onToggle={this.handleToggle.bind(this,3)} />
                                </td>
                            </tr>
