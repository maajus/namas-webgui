...
@connect((store) => {
    ...
    return {
        data:store.Status.data.Corridor,
    };
})


export default class Corridor extends React.Component {
    ...
    handleToggle(name,state) {
        ...
        this.props.dispatch(sendCommand("Set","Light",{Corridor:name}));
        //let obj = "L"+name;
    ...
    render() {
        ...
        return (
            <div className="container-fluid">
                <h3 style={{paddingRight:"15px"}}> Koridorius </h3>
                ...
                <div className="col-xs-12 col-lg-9">
                    ...
                    <table  className="table" style={{paddingLeft:"30px"}}>
                        <tbody>
                            ...
                            <tr>
                                <td style={td_style} className="my-label">Sandėliukas: </td>
                                <td style={td_style} >
                                    <ToggleButton
                            ...
                            <tr>
                                <td style={td_style} className="my-label">Koridorius: </td>
                                <td style={td_style} >
                                    <ToggleButton
                            ...
                            <tr>
                                <td style={td_style} className="my-label">Koridorius prie durų: </td>
                                <td style={td_style} >
                                    <ToggleButton
