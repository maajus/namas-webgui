...
@connect((store) => {
    ...
    return {
        data:store.Status.data.Bathroom,
    };
})
...
export default class Bathroom extends React.Component {
    ...
    handleToggle(name,state) {
        ...
        this.props.dispatch(sendCommand("Set","Light",{Bathroom:name}));
        //let obj = "L"+name;
    ...
    render() {
        ...
        return (
            <div className="container-fluid">
                <h3 style={{paddingRight:"15px"}}> Vonia </h3>
                ...
                <div className="col-xs-12 col-lg-9">
                    ...
                    <table  className="table" style={{paddingLeft:"30px"}}>
                        <tbody>
                            ...
                            <tr>
                                <td style={td_style} className="my-label">LED: </td>
                                <td style={td_style} >
                                    <ToggleButton
                            ...
                            <tr>
                                <td style={td_style} className="my-label">Veidrodis: </td>
                                <td style={td_style} >
                                    <ToggleButton
