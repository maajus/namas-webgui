...
class Wav {
    ...
    getWavInt16Array(buffer) {
        ...
        intBuffer[2] = (2*buffer.length) & 0x0000ffff; // RIFF size
        intBuffer[3] = ((2*buffer.length) & 0xffff0000) >> 16; // RIFF size
...
/*                if(intBuffer[i+23] == -16376 */
                    //|| intBuffer[i+23] == -32745 
                    //|| intBuffer[i+23] == -32751 
                    //|| intBuffer[i+23] == 16410)
                    /*intBuffer[i+23] = 0;*/
            }
        }
